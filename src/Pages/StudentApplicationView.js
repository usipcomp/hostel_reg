                                        ...
                                        <View style={styles.columnsContainer}>
                                            <View style={styles.column}>
                                                ...
                                                <View style={styles.dataSections}>
                                                    ...
                                                    <Text style={styles.data}>{application.phone_no}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Email-ID`}</Text>
                                                ...
                                                <View style={styles.dataSections}>
                                                    ...
                                                    <Text style={styles.data}>{application.year_of_admission}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Blood Group`}</Text>
                                                    <Text style={styles.data}>{application.blood_group}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Distance`}</Text>
                                                    <Text style={styles.data}>{application.distance}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Region`}</Text>
                                                ...
                                                {/* Father details */}
                                                <Text style={styles.nxtLineHeaders}>PARENTS DETAILS</Text>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Father Name`}</Text>
                                                    <Text style={styles.data}>{application.father_name}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                ...
                                                <View style={styles.dataSections}>
                                                    ...
                                                    <Text style={styles.data}>{application.father_email}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
...
mother_phone_no}</Text>
                                                ...
                                                <View style={styles.dataSections}>
                                                    ...
                                                    <Text style={styles.data}>{application.mother_email}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                ...
                                                <View style={styles.dataSections}>
                                                    <Text>{`Home City`}</Text>
                                                    <Text style={styles.data}>{application.home_city}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Home State`}</Text>
                                                    <Text style={styles.data}>{application.home_state}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Home Country`}</Text>
                                                    <Text style={styles.data}>{application.home_country}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Home Pincode`}</Text>
                                                    <Text style={styles.data}>{application.home_pincode}</Text>
                                                </View>
                                                <Text style={styles.nxtLineHeaders}>LOCAL GAURDIAN DETAILS</Text>
                                                <View style={styles.dataSections}>
                                            ...
                                            <View style={styles.column}>
                                                ...
                                                <View style={styles.dataSections}>
                                                    <Text>{`Semester`}</Text>
                                                    <Text style={styles.data}>{application.semester}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Back Papers`}</Text>
                                                    <Text style={styles.data}>{application.back_papers}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`SGPA`}</Text>
                                                ...
                                                <View style={styles.dataSections}>
                                                    ...
                                                    <Text style={styles.data}>{application.acc_holder_name}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`Bank Name`}</Text>
                                                    <Text style={styles.data}>{application.bank_name}</Text>
                                                </View>
                                                <View style={styles.dataSections}>
                                                    <Text>{`IFSC`}</Text>
