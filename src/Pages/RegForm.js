...
function RegForm({showAlert}) {
  ...
  return (
    <>
      ...
      </div> : <div className="max-w-sm mx-auto my-5 rounded overflow-hidden shadow-lg">
        <div className="px-6 py-4">
          <div className="font-bold text-xl mb-2">OOPS! Sorry the form is no longer accepting responses</div>
        </div>
      </div>}
    </>
  );
