...
const HostelDCard = () => {
  ...
  const instructionList = [
    "The ID card must be displayed by holder upon entering hostel premises",
    "In case of loss,duplicate card will be issued on payment of Rs 200/-",
    "Please ensure safe custody of ID card and in case of loss report immediately to hostel office.",
  ];
  ...
  const getAllotedData = async () => {
    const response = await fetch(
      "http://localhost:4000/hostelreg/applications/auth/getAllotedData",
      {
        method: "POST",
        headers: {
                ...
                <View style={styles.container}>
                  <View style={styles.column}>
                    ...
                    <Text style={styles.headers}>
                      Hostel ID Card{`(Session : 2022-2023)`}
                    </Text>
                  ...
                  <View style={styles.column}>
                    ...
                    <View style={styles.instructions}>
                      ...
                      <View style={styles.columnDataInstr}>{ListItem}</View>
